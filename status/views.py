...
# class StatusListCreateApiView(generics.ListAPIView, mixins.CreateModelMixin, mixins.UpdateModelMixin):
#       queryset = Status.objects.all()
#       serializer_class = StatusSerializer
...
# class StatusDetailDeleteUpdateView(generics.RetrieveAPIView, mixins.DestroyModelMixin):
#       queryset = Status.objects.all()
#       serializer_class = StatusSerializer
